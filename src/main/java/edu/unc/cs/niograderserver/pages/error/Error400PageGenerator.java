...
public class Error400PageGenerator implements IError400PageGenerator {
    ...
    private IBody buildBody() {
        ...
        title.addContent(new Header("Error 400: Bad Request", 1));
        ...
        waitNote.addContent(new Text("The request for this page was not correct, please tell a TA what you did to get this."));
    ...
    private IHead buildHead() {
        ITitle title = new Title("Error 400");
