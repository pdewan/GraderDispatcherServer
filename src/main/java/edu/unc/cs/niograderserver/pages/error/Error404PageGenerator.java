...
public class Error404PageGenerator implements IError404PageGenerator {
    ...
    private IBody buildBody() {
        ...
        title.addContent(new Header("Error 404: Not Found", 1));
        ...
        waitNote.addContent(new Text("This page could not be found. If it should have been, please contact a TA."));
    ...
    private IHead buildHead() {
        ITitle title = new Title("Error 404");
